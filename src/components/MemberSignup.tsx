...
export default function MemberSignup({ onBack }: MemberSignupProps) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-blue-50 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Your membership application has been submitted and is awaiting approval from our librarian.
            Once approved, you'll be able to log in and access all library features including browsing books,
            making reservations, and writing reviews.
          </p>
          <button
            onClick={onBack}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Sign up to join our library</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> After creating your account, it will need to be approved by a librarian
                before you can access library services.
              </p>
            </div>
